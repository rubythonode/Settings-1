...
<div class="box-body" >
    <div class="nav-tabs-custom">
        ...
        ->action(URL::to('admin/settings/setting/'. $setting['id']))!!}
...
<script type="text/javascript">
        ...
        (function ($) {
            $('#btn-close').click(function(){
                $('#entry-setting').load('{{URL::to('admin/settings/setting')}}/{{$setting->id}}');
            });
            ...
            $('#edit-setting')
            .submit( function( e ) {
                var formURL  = "{{ URL::to('admin/settings/setting/')}}/{{@$setting->id}}";
                $.ajax( {
                    url: formURL,
                    type: 'POST',
